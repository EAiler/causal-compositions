...
def sim_IV_negbinomial(key,
    ...
    print("******************************************************+++++++++++++*****")
    print("1. Start modelling first stage")
    start = time.time()
    ...
    print("******************************************************+++++++++++++*****")
    print("2. Add pseudo count to zero terms")
    start = time.time()
    ...
    print("******************************************************+++++++++++++*****")
    print("3. Start modelling first stage for intervention setup")
    start = time.time()
    key, subkey = jax.random.split(key)
    ...
    print("******************************************************+++++++++++++*****")
    print("4. Start iteration for intervention computation")
    num = 80
    for iter in range(num):
        print("..............................................")
        print("This is round " + str(iter) + " of " + str(num))
        start = time.time()
        key, subkey = jax.random.split(key, )
...
def sim_IV_ilr_nonlinear(key,
    ...
    def fct_nonlinear(beta0, X_sim_ilr, confounder, mu_c, do_confounder):
        ...
        # Test 1
        Y_sim = beta0 + 1 / 10*(X_sim_ilr @ betaT) + 1 / 10 * ((X_sim_ilr + 1) ** 5 @ np.ones(p - 1, ))

        # Test 2
        Y_sim = beta0 + 1 / 10*(X_sim_ilr @ betaT) + 1 / 25 * ((X_sim_ilr + 1) ** 5 @ np.ones(p - 1, ))
